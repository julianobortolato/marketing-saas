...
- [ ] 03-02-PLAN.md — Sprint 3 observability + handoff UI slice: /dashboard/conversas list+detail+handoff toggle + /dashboard/configuracoes/editorial CRUD + GET /api/admin/saude-mkt diagnostics (WHATS-03)

**Wave 3** *(blocked on Wave 2 completion)*

- [ ] 03-03-PLAN.md — Sprint 4 smoke suite + cutover: 8 smoke tests per ADR §11 (incl. anti-leak gate against fictitious Vértice tenant) + gated 10%→50%→100% cutover checklist (WHATS-01, WHATS-02, WHATS-03)
